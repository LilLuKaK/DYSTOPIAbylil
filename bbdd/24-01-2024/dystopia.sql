...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-01-2024 a las 14:13:52
...
(9, 'The Boy', 'Drake', 5, 19, 'https://i.imgur.com/NV42tot.jpg');
...
INSERT INTO `cuentas` (`id_cuenta`, `nombre_cuenta`, `apellidos_cuenta`, `direccion_cuenta`, `email_cuenta`, `telefono_cuenta`, `cpostal_cuenta`, `clave_cuenta`) VALUES
(10, 'Lucas', 'Bravo', 'Los arces', 'srbylukasmicz@gmail.com', 611425518, 28922, '$2y$10$8I68lr/X8DFaSHawNuqlO.93VysBLrsCqxoHOAxF7DgZeFxlVMhEC');
...
--
ALTER TABLE `albumes`
  MODIFY `id_album` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `cuentas`
  MODIFY `id_cuenta` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
